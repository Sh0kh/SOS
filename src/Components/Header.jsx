...
import header__log from '../img/header__logo.png'
        ...
        <div className='container'>
            <div className='header__wrapper'>
                ...
                <div className='header__function'>
                    <h2>
                        ENG <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none">
                            <path d="M1.48047 1.11331L5.12832 4.31369L8.77552 1.11331" stroke="white" stroke-width="1.4" stroke-linecap="round"/>
                            </svg>
                    </h2>
                    <svg className='header__lin' xmlns="http://www.w3.org/2000/svg" width="2" height="32" viewBox="0 0 2 32" fill="none">
                        <path opacity="0.5" d="M0.96875 1.14929L0.968751 31.1493" stroke="white" stroke-width="0.873968" stroke-linecap="round"/>
                    </svg>
                    <div onClick={toggleMenu}  className='hamburger'>
                        <Hamburger  color='white' />
                    </div>
                    <div className='header__function__grid'>
